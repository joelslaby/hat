...
namespace google {
namespace protobuf {
template<> ::hat::config::Receiver* Arena::CreateMaybeMessage<::hat::config::Receiver>(Arena*);
}  // namespace protobuf
}  // namespace google
namespace hat {
namespace config {
...
class Receiver : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:hat.config.Receiver) */ {
 public:
  Receiver();
  virtual ~Receiver();
  ...
  inline Receiver* New() const final {
    return CreateMaybeMessage<Receiver>(NULL);
  }

  Receiver* New(::google::protobuf::Arena* arena) const final {
  ...
  // @@protoc_insertion_point(class_scope:hat.config.Receiver)
 private:
  void set_has_app();
  void clear_has_app();
...
// optional .goby.middleware.protobuf.AppConfig app = 1;
inline bool Receiver::has_app() const {
  return (_has_bits_[0] & 0x00000001u) != 0;
}
inline void Receiver::set_has_app() {
  _has_bits_[0] |= 0x00000001u;
}
inline void Receiver::clear_has_app() {
  _has_bits_[0] &= ~0x00000001u;
}
inline const ::goby::middleware::protobuf::AppConfig& Receiver::_internal_app() const {
  return *app_;
}
inline const ::goby::middleware::protobuf::AppConfig& Receiver::app() const {
  const ::goby::middleware::protobuf::AppConfig* p = app_;
  // @@protoc_insertion_point(field_get:hat.config.Receiver.app)
...
inline ::goby::middleware::protobuf::AppConfig* Receiver::release_app() {
  // @@protoc_insertion_point(field_release:hat.config.Receiver.app)
  clear_has_app();
  ::goby::middleware::protobuf::AppConfig* temp = app_;
  app_ = NULL;
  return temp;
}
inline ::goby::middleware::protobuf::AppConfig* Receiver::mutable_app() {
  set_has_app();
  if (app_ == NULL) {
    auto* p = CreateMaybeMessage<::goby::middleware::protobuf::AppConfig>(GetArenaNoVirtual());
    app_ = p;
  }
  // @@protoc_insertion_point(field_mutable:hat.config.Receiver.app)
  return app_;
}
inline void Receiver::set_allocated_app(::goby::middleware::protobuf::AppConfig* app) {
  ...
  app_ = app;
  // @@protoc_insertion_point(field_set_allocated:hat.config.Receiver.app)
}

// optional .goby.zeromq.protobuf.InterProcessPortalConfig interprocess = 2;
inline bool Receiver::has_interprocess() const {
  return (_has_bits_[0] & 0x00000002u) != 0;
}
inline void Receiver::set_has_interprocess() {
  _has_bits_[0] |= 0x00000002u;
}
inline void Receiver::clear_has_interprocess() {
  _has_bits_[0] &= ~0x00000002u;
}
inline const ::goby::zeromq::protobuf::InterProcessPortalConfig& Receiver::_internal_interprocess() const {
  return *interprocess_;
}
inline const ::goby::zeromq::protobuf::InterProcessPortalConfig& Receiver::interprocess() const {
  const ::goby::zeromq::protobuf::InterProcessPortalConfig* p = interprocess_;
  // @@protoc_insertion_point(field_get:hat.config.Receiver.interprocess)
...
inline ::goby::zeromq::protobuf::InterProcessPortalConfig* Receiver::release_interprocess() {
  // @@protoc_insertion_point(field_release:hat.config.Receiver.interprocess)
  clear_has_interprocess();
  ::goby::zeromq::protobuf::InterProcessPortalConfig* temp = interprocess_;
  interprocess_ = NULL;
  return temp;
}
inline ::goby::zeromq::protobuf::InterProcessPortalConfig* Receiver::mutable_interprocess() {
  ...
  // @@protoc_insertion_point(field_mutable:hat.config.Receiver.interprocess)
  return interprocess_;
}
inline void Receiver::set_allocated_interprocess(::goby::zeromq::protobuf::InterProcessPortalConfig* interprocess) {
  ::google::protobuf::Arena* message_arena = GetArenaNoVirtual();
  if (message_arena == NULL) {
  ...
  // @@protoc_insertion_point(field_set_allocated:hat.config.Receiver.interprocess)
}
